<?php
#an instance of server.php maintains connection to the target host and relay traffic between the cient and the target host
#each instance of server.php corresponds to a unique connection and share the life time with the connection
